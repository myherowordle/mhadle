...
import { GridVigilanteComponent } from './grid-vigilante.component';

describe('GridVigilanteComponent', () => {
  let component: GridVigilanteComponent;
  let fixture: ComponentFixture<GridVigilanteComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(GridVigilanteComponent);
  ...
  it('should render the guessed EX Skill cost correctly', fakeAsync(() => {
    ...
    expect(spanElement.nativeElement.textContent.trim()).toBe(
      String(mockStudentAru.vigilante)
    );
  }));
