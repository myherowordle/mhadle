...
import { GridOccupationComponent } from './grid-occupation.component';

describe('GridOccupation', () => {
  let component: GridOccupationComponent;
  let fixture: ComponentFixture<GridOccupationComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(GridOccupationComponent);
