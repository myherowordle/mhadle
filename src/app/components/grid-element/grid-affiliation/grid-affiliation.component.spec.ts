...
import { GridAffiliationComponent } from './grid-affiliation.component';

describe('GridAffiliation', () => {
  let component: GridAffiliationComponent;
  let fixture: ComponentFixture<GridAffiliationComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(GridAffiliationComponent);
