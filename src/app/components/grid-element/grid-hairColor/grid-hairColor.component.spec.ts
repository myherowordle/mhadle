...
import { GridHairColor } from './grid-hairColor.component';

describe('GridHairColor', () => {
  let component: GridHairColor;
  let fixture: ComponentFixture<GridHairColor>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(GridHairColor);
