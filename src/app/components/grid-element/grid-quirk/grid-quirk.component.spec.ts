...
import { GridQuirkComponent } from './grid-quirk.component';

describe('GridQuirkComponent', () => {
  let component: GridQuirkComponent;
  let fixture: ComponentFixture<GridQuirkComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(GridQuirkComponent);
