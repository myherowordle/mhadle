...
import { GridWeaponTypeComponent } from './grid-quirk-type.component';
...
describe('GridWeaponTypeComponent', () => {
  ...
  it('should render the correct quirk type text', fakeAsync(() => {
    component.guess = mockStudentAru;
    fixture.detectChanges();
    fixture.whenStable();
    tick(420);
    ...
    expect(spanElement.nativeElement.textContent.trim()).toBe(
      mockStudentAru.quirkType
    );
  }));

  it('should correctly format quirk type using dashCase pipe', fakeAsync(() => {
    component.guess = mockStudentAru;
    fixture.detectChanges();
    fixture.whenStable();
    tick(420);
    ...
    const divElement = fixture.debugElement.query(By.css('div > div > div'));
    expect(divElement.nativeElement.classList).toContain('normal-quirk-type');
  }));
