...
import { GridAliasComponent } from './grid-alias.component';

describe('GridAliasComponent', () => {
  let component: GridAliasComponent;
  let fixture: ComponentFixture<GridAliasComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(GridAliasComponent);
