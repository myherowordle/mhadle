...
import { GridHeightComponent } from './grid-height.component';

describe('GridHeightComponent', () => {
  let component: GridHeightComponent;
  let fixture: ComponentFixture<GridHeightComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(GridHeightComponent);
