...
import { GridMangaComponent } from './grid-manga.component';

describe('GridMangaComponent', () => {
  let component: GridMangaComponent;
  let fixture: ComponentFixture<GridMangaComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(GridMangaComponent);
