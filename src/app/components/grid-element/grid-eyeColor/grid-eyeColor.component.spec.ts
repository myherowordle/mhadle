...
import { GridEyeColor } from './grid-eyeColor.component';

describe('GridEyeColor', () => {
  let component: GridEyeColor;
  let fixture: ComponentFixture<GridEyeColor>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(GridEyeColor);
